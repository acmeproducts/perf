...
This project: `UI-V2-OWNER-ACCEPTANCE.md` (definition of working), `UI-V2-MASTER-PLAN.md` (§138 on; §146 postmortem),
`UI-V2-GRAVEYARD.md` (never revive a buried approach). Suite: `e2e/` (see `e2e/README.md`) and `gate-globe-tap.spec.ts`.
