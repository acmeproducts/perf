# V9B Score Compliance Scorecard

## Executive Summary
- Focus gestures and search tokenization largely match the spec, but modified timestamp coverage remains missing.
- Grid modal teardown still depends on IndexedDB, so operational flows that close the grid fail under persistence errors.
- Cross-device ordering parity inherits the same modal teardown gap, risking stale stack ordering for Device B.
...
|-------------|--------|-------|-------|
| 1.1.1 Hub double-tap toggles focus mode on and off | ✅ Pass | +1 | Double-tap handler toggles focus mode once hub tap thresholds are met.【F:ui-v9b.html†L6670-L6705】 |
| 1.1.2 Focus toggle ignores stray taps in triangular dead zones and never advances two images unintentionally | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 1.1.3 Stack switcher button remains functional while Quick Move logic is active | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 1.1.4 Details button remains functional while Quick Move logic is active | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 1.1.5 Folder button remains functional while Quick Move logic is active | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 1.1.6 Favorites control remains functional while Quick Move logic is active | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 1.1.7 Trash can icon remains functional while Quick Move logic is active | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 1.1.8 Stack navigation produces no regressions after Quick Move integration | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 2.1.1 Search index includes image filenames | ✅ Pass | +1 | Search payload concatenates file names into the searchable text.【F:ui-v9b.html†L5770-L5782】 |
| 2.1.2 Search index includes created timestamps | ✅ Pass | +1 | Created dates are normalized into the search text for filtering.【F:ui-v9b.html†L5770-L5792】 |
| 2.1.3 Search index includes modified timestamps | ❌ Fail | -1 | Modified timestamps never join the searchable payload, leaving last-edit queries unsupported.【F:ui-v9b.html†L5770-L5796】 |
| 2.1.4 Search index includes assigned tags | ✅ Pass | +1 | Assigned tags are joined into the search text payload.【F:ui-v9b.html†L5770-L5776】 |
| 2.1.5 Search index includes image notes | ✅ Pass | +1 | Image notes flow into the searchable string.【F:ui-v9b.html†L5770-L5777】 |
| 2.1.6 Search index includes parsed metadata fields | ✅ Pass | +1 | Extracted metadata is stringified into the search payload for lookup.【F:ui-v9b.html†L5770-L5793】 |
| 2.1.7 Search index includes PNG embedded text (zTXt or similar) | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 2.2.1 Query parsing applies #modifier tokens before positive terms | ✅ Pass | +1 | Modifier parsing runs before other query phases, including #favorite and ratings filters.【F:ui-v9b.html†L5723-L5755】 |
| 2.2.2 Query parsing applies positive inclusion terms after modifiers | ✅ Pass | +1 | Positive inclusions evaluate after modifiers to narrow matches.【F:ui-v9b.html†L5770-L5782】 |
| 2.2.3 Query parsing applies exclusion terms after positive terms | ✅ Pass | +1 | Exclusion terms execute last to prune remaining results.【F:ui-v9b.html†L5784-L5796】 |
| 2.2.4 Grid view and stage remain synchronized after search filtering | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 2.2.5 Search results maintain stage ordering when filters apply | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 2.2.6 Search results expose #favorite items when requested | ✅ Pass | +1 | Favorite modifier path filters results to files flagged as favorites.【F:ui-v9b.html†L5742-L5746】 |
| 2.2.7 Search selections remain active until the search pill is cleared | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 2.3.1 Desktop users can click modifier buttons without closing the helper automatically | ❌ Fail | -1 | Modifier links invoke `closeHelper`, so the overlay disappears immediately after selection.【F:ui-v9b.html†L7283-L7334】 |
...
| 5.1.5 IndexedDB warm cache stores PNG text payloads | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
...
| 10.1.1.4 Selecting Google Drive begins the proper auth flow | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
...
| 10.2.5.12 Users can navigate from Trash to Maybe stack | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
...
| 10.5.8 Tag modal layout and behavior identical between details tab and bulk tab | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 11.1.1 Authenticated launch restores the most recently opened folder view with correct stack context | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 11.1.2 Navigating between stacks updates stage, grid, and counters without desync | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 11.1.3 Applying search filters updates visible items while preserving selection and focus state | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 11.1.4 Editing metadata (tags, notes, favorites) reflects immediately in both stage and grid views | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 11.1.5 Exporting selected items succeeds without interfering with ongoing browsing actions | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 11.1.6 Closing and reopening the app preserves pending changes and resumes normal operation seamlessly | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 11.2.1 Device A commits metadata and ordering changes for a folder before Device B opens it for the first time, and Device B loads those changes on initial entry | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 11.2.2 Device B's first session caches folder metadata without preventing subsequent updates from Device A | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 11.2.3 Additional metadata or ordering changes made on Device A after Device B's initial visit are persisted to the shared manifest | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 11.2.4 When Device B re-enters the same folder, it refreshes metadata, sort order, and deletions to match Device A's latest state | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
| 11.2.5 Device B surfaces conflicts or sync errors when expected updates from Device A cannot be applied automatically | ⚪ Undetermined | +0 | Not evaluated during this review window; further manual regression is required. |
...
| Requirement | Status | Score | Notes |
|-------------|--------|-------|-------|
| 1.1 Authenticate with the selected storage provider. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 1.2 Choose a parent folder and drill into a child folder that contains multiple images (OneDrive). | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 1.3 Choose a folder that contains multiple images (Google Drive). | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 1.4 Load the folder and confirm the first image appears on the main stage in the **In** stack. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.1 Confirm the initial sort order of the **In** stack. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.2 Flick Image 1 upward into the **Keep** stack. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.3 Flick Image 2 to the right into the **Maybe** stack. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.4 Flick Image 3 downward into the **Trash** stack. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.5 Flick Image 4 to the left to return it to the **In** stack. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.6 Open the **In** stack grid view. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.7 Enter Focus Mode from the grid. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.8 Swipe left three times (advancing forward through images). | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.9 Exit Focus Mode. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.10 Navigate sequentially to the **Keep**, **Maybe**, **Trash**, and back to the **In** stack. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.11 Re-enter Focus Mode from the **In** stack. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.12 Swipe right four times (navigating backward). | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.13 Press the delete control twice to remove two images while in Focus Mode. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
| 2.14 Exit Focus Mode. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
...
| 4.20 Confirm only the tagged image appears and is pre-selected. | ⚪ Undetermined | +0 | Not evaluated during this review window aside from identified blockers. |
...
| Requirement | Status | Score | Notes |
|-------------|--------|-------|-------|
| 1.1 Authenticate Device A with the storage provider and open Folder X that contains multiple images. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 1.2 Authenticate Device B with the same provider, but remain on the provider selection screen. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 1.3 Ensure Folder X has no pending sync operations in either device's local state. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 2.1 On Device A, confirm Folder X loads on the **In** stack stage. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 2.2 Apply unique tags to three different images (e.g., `#sync-a1`, `#sync-a2`, `#sync-a3`). | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 2.3 Add distinct notes to the same three images. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 2.4 Mark one image as a favorite. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 2.5 Move one image from **In** to **Keep** and another from **In** to **Maybe**. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 2.6 Delete one image to send it to the provider recycle bin. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 2.7 Export metadata for the modified items and confirm completion. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 2.8 Verify Device A's sync queue is empty (no pending writes). | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 3.1 Authenticate Device B and open Folder X for the first time. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 3.2 Confirm the stage reflects Device A's latest ordering (favorite, Keep, Maybe adjustments). | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 3.3 Verify the three tags from Section 2.2 are present on the corresponding images. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 3.4 Confirm the associated notes from Section 2.3 are visible. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 3.5 Verify the favorite state matches Device A's selection. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 3.6 Confirm the deleted image no longer appears in any stack. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 3.7 Review sync diagnostics/logs to ensure no errors were raised during hydration. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 4.1 On Device A, apply a new batch of tags (e.g., `#sync-a4`, `#sync-a5`). | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 4.2 Edit the note on one previously modified image. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 4.3 Clear the favorite flag that was set earlier. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 4.4 Restore the previously deleted image from the provider recycle bin. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 4.5 Move two images between stacks to verify ordering churn. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 4.6 Confirm the sync queue drains successfully after each change batch. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 5.1 Re-open Folder X on Device B after Device A completes Section 4. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 5.2 Confirm new tags (`#sync-a4`, `#sync-a5`) appear on the correct images. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 5.3 Verify the edited note reflects Device A's latest text. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 5.4 Confirm the favorite flag is cleared. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 5.5 Verify the restored image reappears in the expected stack position. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 5.6 Ensure stack ordering matches Device A's latest moves. | ❌ Fail | -1 | Device B cannot trust stack ordering because `Grid.close()` persists order through IndexedDB writes that may reject.【F:ui-v9b.html†L5371-L5389】【F:ui-v9b.html†L5801-L5826】 |
| 5.7 Validate that no sync conflicts are reported in diagnostics. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 6.1 Ensure Device B can still enter Focus Mode and navigate without desynchronizing selections. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
| 6.2 Confirm both devices can search for the new tags and receive consistent results. | ✅ Pass | +1 | Tag filters propagate through the search pipeline, so both devices can find the injected tags.【F:ui-v9b.html†L5770-L5776】【F:ui-v9b.html†L5770-L5782】 |
| 6.3 Validate export operations continue to function on both devices post-sync. | ⚪ Undetermined | +0 | Not evaluated during this review window except for documented findings. |
